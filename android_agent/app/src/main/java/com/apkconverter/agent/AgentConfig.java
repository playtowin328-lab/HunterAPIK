...
final class AgentConfig {
    ...
    static final String KEY_LAST_COMMAND_ERROR = "last_command_error";
    static final String KEY_COMMAND_ERROR_COUNT = "command_error_count";
    static final String KEY_PENDING_COMPLETION_ID = "pending_completion_id";
    static final String KEY_PENDING_COMPLETION_TYPE = "pending_completion_type";
    static final String KEY_PENDING_COMPLETION_STATUS = "pending_completion_status";
    static final String KEY_PENDING_COMPLETION_RESULT = "pending_completion_result";
    static final String KEY_PENDING_COMPLETION_MS = "pending_completion_ms";
    static final String KEY_LAST_ERROR_COUNT = "last_error_count";
    static final String KEY_LAST_ERROR = "last_error";
    static final String KEY_LAST_REPAIR_MS = "last_repair_ms";
    static final String KEY_LAST_REPAIR_REASON = "last_repair_reason";
    static final String KEY_SELF_REPAIR_COUNT = "self_repair_count";
