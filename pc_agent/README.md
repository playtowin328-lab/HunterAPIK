...
В версии `0.6.0` heartbeat получил отдельный короткий сетевой бюджет и fast reconnect с jitter до 15 секунд. Пульт показывает ID сессии, uptime, номер heartbeat, число восстановлений и длительность последнего сбоя.
